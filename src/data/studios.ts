...
export const studios: Studio[] = [
  {
    ...
    surface: 35,
    description: {
      fr: 'Studio lumineux avec séjour ouvert sur une cuisine équipée et vue sur le village de Pals. Un espace confortable pour profiter de la tranquillité de l\'Empordà.',
      es: 'Estudio luminoso con salón abierto a una cocina equipada y vistas al pueblo de Pals. Un espacio cómodo para disfrutar de la tranquilidad del Empordà.',
      en: 'Bright studio with open living area, fully equipped kitchen and views of Pals village. A comfortable space to enjoy the tranquility of the Empordà.',
      de: 'Helles Studio mit offenem Wohnbereich, voll ausgestatteter Küche und Blick auf das Dorf Pals. Ein komfortabler Raum, um die Ruhe des Empordà zu genießen.',
      ca: 'Studio lluminós amb sala oberta a una cuina equipada i vistes al poble de Pals. Un espai confortable per gaudir de la tranquil·litat de l\'Empordà.',
    },
  ...
  },
  {
    ...
    surface: 30,
    description: {
      fr: 'Studio cosy avec décoration soignée. Un cocon chaleureux au coeur de l\'Arenal, avec accès direct au café en contrebas.',
      es: 'Estudio acogedor con decoración cuidada. Un rincón cálido en el corazón del Arenal, con acceso directo al café de abajo.',
      en: 'Cosy studio with tasteful décor. A warm retreat at the heart of the Arenal, with direct access to the café below.',
      de: 'Gemütliches Studio mit geschmackvoller Einrichtung. Ein warmer Rückzugsort im Herzen des Arenal, mit direktem Zugang zum Café darunter.',
      ca: 'Studio acollidor amb decoració acurada. Un racó càlid al cor de l\'Arenal, amb accés directe al cafè de sota.',
    },
    features: ['terrace', 'kitchen', 'wifi', 'aircon', 'tv', 'parking'],
  },
  {
